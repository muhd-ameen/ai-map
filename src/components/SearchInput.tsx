      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative group">
          <input
            ...
            disabled={isLoading}
            className="w-full px-6 py-4 pl-14 pr-20 text-lg bg-white border-2 border-gray-200 rounded-2xl focus:border-transparent focus:ring-4 focus:ring-indigo-200 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          />
          ...
          <button
            ...
            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-indigo-500 via-purple-500 to-teal-400 hover:from-indigo-600 hover:via-purple-600 hover:to-teal-500 text-white px-6 py-2 rounded-xl font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg hover:shadow-xl"
          >
            {isLoading ? (
